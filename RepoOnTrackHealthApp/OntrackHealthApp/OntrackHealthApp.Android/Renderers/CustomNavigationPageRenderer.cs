...
namespace OntrackHealthApp.Droid.Renderers
{
    public class CustomNavigationPageRenderer : NavigationPageRenderer
    {
        ...
        private void LastPage_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            else if (e.PropertyName == CustomContentPage.FormattedTitleProperty.PropertyName && (lastPage is CustomContentPage))
            {
                var cPage = lastPage as CustomContentPage;
            ...
            else if (e.PropertyName == CustomContentPage.SubtitleProperty.PropertyName && (lastPage is CustomContentPage))
            {
                var cPage = lastPage as CustomContentPage;
        ...
        {
            //Check support for CustomContentPage 
            if (lastPage is CustomContentPage)
            {
                var cPage = lastPage as CustomContentPage;
        ...
        void UpdateToolbarSubtitle(CustomContentPage cPage, AppCompatTextView subTitleTextView, Typeface originalFont, ColorStateList defaultColorStateList)
            {

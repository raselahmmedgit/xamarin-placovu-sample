   ...
   public class CustomPageRenderer : PageRenderer
    {
        ...
        void SetTitlePosition( CustomNavigationPage.TitleAlignment alignment,Thickness padding, Thickness margin, CGRect vFrame)
        {
            ...
            var cPage = Element as CustomContentPage;
        ...
        private void Element_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == Page.TitleProperty.PropertyName  || e.PropertyName == CustomNavigationPage.TitleFontProperty.PropertyName || e.PropertyName == CustomContentPage.SubtitleProperty.PropertyName || e.PropertyName == CustomNavigationPage.SubtitleFontProperty.PropertyName)
            {
                 SetupTextFont(titleLabel, CustomNavigationPage.GetTitleFont(page), CustomNavigationPage.GetTitleColor(page));
            ...
            else if (e.PropertyName == CustomContentPage.FormattedTitleProperty.PropertyName && (page is CustomContentPage))
            {
                var cPage = page as CustomContentPage;
                SetupFormattedText(titleLabel, cPage.FormattedTitle, cPage.Title);

...
namespace OntrackHealthApp.ChartHelper.Models
{
    public class ChartConfiguration
    {
        ...
        public string GenerateChart()
        {
            ...
            //var resourceFolder = NSBundle.MainBundle.BundlePath;
            //var localScript = "<script src='"+resourceFolder+"//chart_bundle.js' type='text/javascript'></script>";
            var localScript = "<script src='https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.bundle.js' type='text/javascript'></script>";
            var style = @"<style>#mycanvas{width: 650px;padding:0; margin:0;} .conteiner{overflow-x:auto}</style>";
        ...
        {
            var chartWidth = _chartData.IsCompactViewGraph ? "350px" : "650px";
            var chartHeight = "330px"; 
            ...
            chartConfigScript = $@"var config = {chartConfigWithData};
                ...
                window.onload = function() {{
                  ...
                  chart.canvas.style.height = '{chartHeight}';
                  chart.canvas.style.width = '{chartWidth}';
                }};";            
        }
        ...
        private string SetRoundedYAxisValue()
        {
            StringBuilder builder = new StringBuilder();
            builder.Append(@"function (label, index, labels) {
        ...
        private object GenerateChartOptions()
        {
            ...
            {
                responsive = _chartData.IsCompactViewGraph,
                    ...
                    xAxes = new[]
                    {
                        new
                        {
                            ...
                            gridLines = new
                            {
                                zeroLineWidth= 1,
                                zeroLineColor= "#000",
                                display = !_chartData.HideXAxisGrid
                            },
                            scaleLabel = new
                            {
                                display= true,
                    ...
                    yAxes = new[]
                    {
                        new
                        {
                            ...
                            ticks = new
                            {
                                ...
                                beginAtZero = true,
                                precision = 0,
                                userCallBack = SetRoundedYAxisValue()
                            },
                            stacked = _chartData.IsStackedBarChart,
                            gridLines = new
                            {

...
namespace OntrackHealthApp
{
	...
	public partial class PhysicianPageNew : ContentPage
    {
        private readonly ITokenContainer _iTokenContainer;
        private readonly IProcedureClient _iProcedureClient;

        public PhysicianPageNew ()
		{
        ...
        protected override void OnAppearing()
        {
            ...
            string url = AppConstant.BaseAddress;
            url += "Physician/Index?id=" + _iTokenContainer.CurrentPatientProcedureDetailId 
                + "&patientProfileId=" + _iTokenContainer.ApiPatientProfileId.ToString() 
                + "&practiceProfileId=" + _iTokenContainer.ApiPracticeProfileId.ToString() 
                + "&isSystemAdmin=false";

            NotificationDetailWebView.Source = new UrlWebViewSource
            {
                Url = url
            };
        }

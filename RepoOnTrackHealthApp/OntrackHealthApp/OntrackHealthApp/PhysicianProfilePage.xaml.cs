...
namespace OntrackHealthApp
{
	...
	public partial class PhysicianProfilePage : ContentPage
    {
        ...
        protected override async void OnAppearing()
        {
            ...
            using (UserDialogs.Instance.Loading(""))
            {
                try
                {
                    ...
                    {
                        PhysicianIndexPageViewModel result = response.Data;
                        BindingContext = result;
                        ProfessionalBioEducations.ItemsSource = result.ProfessionalBioEducations;
                        ProfessionalAssociation.ItemsSource = result.ProfessionalBioAssociations;
                        ProfessionalBioInterests.ItemsSource = result.ProfessionalBioInterests;
                        ProfessionalBioCustomSections.ItemsSource = result.ProfessionalBioCustomSections;
                        ProfessionalBioLicensures.ItemsSource = result.ProfessionalBioLicensureViews;

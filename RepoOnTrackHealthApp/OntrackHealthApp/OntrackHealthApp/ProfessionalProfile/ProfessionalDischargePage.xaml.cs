...
namespace OntrackHealthApp.ProfessionalProfile
{
    ...
    public partial class ProfessionalDischargePage : ContentPage
    {
        ...
        public ProfessionalDischargePage(SurgicalConciergePatientViewModel surgicalConciergeViewModel)
        {
            InitializeComponent();
        ...
        protected async Task AdditionalCommentButton_ClickedAsync(object sender, EventArgs args, Button btnSource)
        {
            ...
            {
                await Navigation.PushModalAsync(new ProfessionalDischargeAdditionalCommentPage(_iTokenContainer.ApiPracticeName, btnSource));
            }
        }
        ...
        protected async Task TemplatedCommentButton_ClickedAsync(object sender, EventArgs args, Label template, Button btnSource, Guid scgDischargeCommentId)
        {
            ...
            //await Navigation.PushAsync(new ProfessionalDischargeDetailPage(_surgicalConciergePatientViewModel, _scgProstatectomyViewModelList, scgDischargeCommentViewModel, _scgProfessionalProcedureProstectomyIdList));
        }
        ...
        private void ShowToolbar()
        {
            ...
            if (Device.RuntimePlatform == Device.iOS)
            {
                ...
                {
                    Navigation.PushAsync(new ProfessionalRecipientPage(_surgicalConciergePatientViewModel, (long)PracticeDivisionUnit.Discharge));
                }, 0, 0);

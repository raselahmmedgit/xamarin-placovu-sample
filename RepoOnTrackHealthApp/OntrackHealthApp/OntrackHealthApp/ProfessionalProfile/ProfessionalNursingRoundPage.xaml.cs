...
namespace OntrackHealthApp.ProfessionalProfile
{
	...
	public partial class ProfessionalNursingRoundPage : ContentPage
	{
        ...
        public ProfessionalNursingRoundPage(SurgicalConciergePatientViewModel surgicalConciergePatientViewModel, long practiceDivisionUnit)
        {
            InitializeComponent();
            ...
            viewModel.LoadProfessionalNursingRound();
        }

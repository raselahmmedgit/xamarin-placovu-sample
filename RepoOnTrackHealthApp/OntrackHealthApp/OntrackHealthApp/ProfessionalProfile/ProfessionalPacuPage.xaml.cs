...
namespace OntrackHealthApp.ProfessionalProfile
{
    ...
    public partial class ProfessionalPacuPage : ContentPage
    {
        ...
        public ProfessionalPacuPage(SurgicalConciergePatientViewModel surgicalConciergeViewModel)
        {
            InitializeComponent();
        ...
        protected async Task btnAdditionalComment_ClickedAsync(object sender, EventArgs args, Button btnSource)
        {
            using (UserDialogs.Instance.Loading(""))
            {
                await Navigation.PushModalAsync(new ProfessionalPacuAdditionalCommentPage(_iTokenContainer.ApiPracticeName, btnSource));
            }
        }
        ...
        protected async Task btnFreeFormCommentModalPage_ClickedAsync(object sender, EventArgs args)
        {
            using (UserDialogs.Instance.Loading(""))
            {
                await Navigation.PushModalAsync(new ProfessionalPacuFreeFormCommentPage(_surgicalConciergePatientViewModel));
            }
        }
        ...
        private void ShowToolbar()
        {
            ...
            if (Device.RuntimePlatform == Device.iOS)
            {
                ...
                {
                    Navigation.PushAsync(new ProfessionalRecipientPage(_surgicalConciergePatientViewModel, (long)PracticeDivisionUnit.PACU));
                }, 0, 0);
        ...
        private void RecipientButton_Clicked(object sender, EventArgs e)
        {
            ...
            using (UserDialogs.Instance.Loading(""))
            {
                try
                {
                    Navigation.PushAsync(new ProfessionalRecipientPage(_surgicalConciergePatientViewModel, (long)PracticeDivisionUnit.OperatingRoom));
                }
                catch (Exception)
                {

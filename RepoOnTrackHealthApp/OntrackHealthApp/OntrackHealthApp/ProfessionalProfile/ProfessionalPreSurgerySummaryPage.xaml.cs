...
namespace OntrackHealthApp.ProfessionalProfile
{
    ...
    public partial class ProfessionalPreSurgerySummaryPage : ContentPage
    {
        ...
        public ProfessionalPreSurgerySummaryPage(SurgicalConciergePatientViewModel surgicalConciergePatientViewModel, PatientPreSurgerySummaryViewModel patientPreSurgerySummaryViewModel)
        {
            InitializeComponent();
        ...
        private void PopulatePiradLesionData()
        {
            ...
            if (columnDefinationCount > 0)
            {
                ...
                //{
                //    new ColumnDefinition{ Width = 90 }//-----------------------------add column
                //};
        ...
        private async void btnEditSummary_ClickedAsync(object sender, EventArgs e)
        {
            ...
            {
                await Navigation.PushAsync(new ProfessionalPreSurgerySummaryEditPage(SurgicalConciergePatientViewModel, _patientPreSurgerySummaryViewModel));
            }
        }
        ...
        private void SubscribeToEvents()
        {
            ...
            MessagingCenter.Unsubscribe<ProfessionalPreSurgerySummaryPiradEditPage, PatientPreSurgerySummaryViewModel>(this, "UpdatePreSummary");

            MessagingCenter.Subscribe<ProfessionalPreSurgerySummaryEditPage, PatientPreSurgerySummaryViewModel>(this, "UpdatePreSummary", (sender, updatedPreSurgerySummary) =>
            {
        ...
        private async void OnXrayButton_Clicked(object sender, EventArgs e)
        {
            ...
            using (UserDialogs.Instance.Loading(""))
            {
                ...
                {
                    await Navigation.PushModalAsync(new ProfessionalPreSurgerySummaryXrayPage(patientPreSurgerySummaryXrayViewModelList));
                }
                else
                {
        ...
        private async void OnAssessmentPlanButton_Clicked(object sender, EventArgs e)
        {
            ...
            using (UserDialogs.Instance.Loading(""))
            {
                ...
                {
                    await Navigation.PushModalAsync(new ProfessionalPreSurgerySummaryAssessmentPlanPage(patientPreSurgerySummaryAssessmentPlanViewModel));
                }
                else
                {
                    await DisplayAlert(AppConstant.DisplayAlertErrorTitle, AppConstant.NullError, AppConstant.DisplayAlertErrorButtonText);

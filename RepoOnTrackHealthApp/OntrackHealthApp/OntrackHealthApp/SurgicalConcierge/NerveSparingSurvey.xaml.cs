...
namespace OntrackHealthApp.SurgicalConcierge
{
    ...
    public partial class NerveSparingSurvey : CustomModalContentPage
    {
        ...
        public NerveSparingSurvey(List<SurveyQuestionDetail> surveyQuestionDetails, SurgicalConciergePatientViewModel surgicalConciergePatientViewModel = null)
        {
            InitializeComponent();

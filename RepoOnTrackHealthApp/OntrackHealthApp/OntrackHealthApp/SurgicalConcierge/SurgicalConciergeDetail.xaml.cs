...
namespace OntrackHealthApp.SurgicalConcierge
{
    ...
    public partial class SurgicalConciergeDetail : ContentPage
    {
        ...
        public SurgicalConciergeDetail(SurgicalConciergeViewModel surgicalConciergeViewModel, SurgicalConciergePatientViewModel surgicalConciergePatientViewModel = null)
        {
            InitializeComponent();
            ...
            using (UserDialogs.Instance.Loading(""))
            {
                ...
                if (apiExecutionResult.Success)
                {
                    ...
                    if (selectedStage.StageId == (long)Enums.NerveSparingEnum.StageId)
                    {
                        ...
                        await Navigation.PushModalAsync(new NerveSparingSurvey(surveyQuestionDetails, SurgicalConciergePatientViewModel));
                    }
                }
                else
                {
        ...
        private async void GetSurgicalComment(object sender, EventArgs e)
        {
            ...
            using (UserDialogs.Instance.Loading(""))
            {
                try
                {
                    ...
                    await Navigation.PushModalAsync(new SurgicalCommentView(surgicalConciergeStageCommentViewModel));
                }
                catch (Exception)
                {
                    await DisplayAlert(AppConstant.DisplayAlertErrorTitle, AppConstant.DisplayAlertErrorMessage, AppConstant.DisplayAlertErrorButtonText);
            ...
            try
            {
                ...
                if (Device.RuntimePlatform == Device.iOS)
                {
                    ...
                    var toolbarItem = new ToolbarItem("Recipient", null, () =>
                    {
                        ...
                        Navigation.PushAsync(new SurgicalConciergeRecipientPage(SurgicalConciergePatientViewModel, (long)PracticeDivisionUnit.OperatingRoom));

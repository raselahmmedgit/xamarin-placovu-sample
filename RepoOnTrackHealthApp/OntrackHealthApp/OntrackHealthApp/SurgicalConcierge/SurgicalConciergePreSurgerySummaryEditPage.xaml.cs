...
namespace OntrackHealthApp.SurgicalConcierge
{
    ...
    public partial class SurgicalConciergePreSurgerySummaryEditPage : ContentPage
    {
        ...
        public SurgicalConciergePreSurgerySummaryEditPage(SurgicalConciergePatientViewModel surgicalConciergePatientViewModel, PatientPreSurgerySummaryViewModel patientPreSurgerySummaryViewModel)
        {
            InitializeComponent();
            ...
            if (InternetConnectHelper.CheckConnection())
            {
                using (UserDialogs.Instance.Loading(""))
                {
                    ...
                    if (result.Success)
                    {
                        ...
                        MessagingCenter.Send<SurgicalConciergePreSurgerySummaryEditPage, PatientPreSurgerySummaryViewModel>(this, "UpdatePreSummary", _patientPreSurgerySummaryViewModel);
                    }
                    else
                    {

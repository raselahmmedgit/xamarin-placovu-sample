...
namespace OntrackHealthApp.SurgicalConcierge
{
	...
	public partial class SurgicalConciergePreSurgerySummaryXrayPage : CustomModalContentPage
    {
        ...
        public SurgicalConciergePreSurgerySummaryXrayPage(PatientPreSurgerySummaryXrayViewModel patientPreSurgerySummaryXrayViewModel)
        {
            InitializeComponent();
            this._patientPreSurgerySummaryXrayViewModel = patientPreSurgerySummaryXrayViewModel;
        }

        public SurgicalConciergePreSurgerySummaryXrayPage(List<PatientPreSurgerySummaryXrayViewModel> patientPreSurgerySummaryViewModelList)
        {
            InitializeComponent();

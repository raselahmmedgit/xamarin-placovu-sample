...
namespace OntrackHealthApp.UserControls
{
    public class MtiEditor : Editor
    {
        ...
        public static readonly BindableProperty AutoSizeEnabledProperty = BindableProperty.Create(nameof(AutoSizeEnabled), typeof(bool), typeof(MtiEntry), false);
        // Gets or sets IsCurvedCornersEnabled value  
        ...
        public virtual void DoInvalidateMeasure()
        {
